Quintus.Ice_Bullet = function(Q) {
Q.Sprite.extend("Ice_Bullet", {
    init: function(p) {
        this._super(p,{
            sheet: "ice",
            sprite: "icebullet_anim",
            scale: 1,
            frame: 0,
            gravity: 0,
            x: 0,
    ...
    hit: function(collision){
        ...
        if(!collision.obj.isA("Samus")) {
            ...
            this.destroy();
            var q = Q.stage();
            q.insert(new Q.Explosion({x: this.p.x ,y: this.p.y, sheet: "ice", sprite: "icebullet_anim"}));
        }

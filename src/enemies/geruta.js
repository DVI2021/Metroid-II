//Geruta TODO Bug con colisiones bump.right al esperar
Quintus.Geruta = function(Q) {
Q.Sprite.extend("Geruta", {
    ...
    init: function (p) {
        ...
        this.on("bump.top, bump.bottom", this, "hit");
